...
AddEventHandler("Phone:Server:RegisterMiddleware", function()
	...
	plsr.Middleware:Add("Characters:Spawning", function(source)
		local sid = plsr.Fetch:CharacterSource(source):GetData("SID")
...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
	plsr.Callbacks:RegisterServerCallback("Phone:Chatter:GetMessageCount", function(source, data, cb)
		local char = plsr.Fetch:CharacterSource(source)
		if char ~= nil then
	...
	plsr.Callbacks:RegisterServerCallback("Phone:Chatter:LoadMessages", function(source, data, cb)
		local char = plsr.Fetch:CharacterSource(source)
		if char ~= nil then
			local sid = char:GetData("SID")
			if _groups[sid] ~= nil then
	...
	plsr.Callbacks:RegisterServerCallback("Phone:Chatter:SendMessage", function(source, data, cb)
		local char = plsr.Fetch:CharacterSource(source)
		if char ~= nil then
			local sid = char:GetData("SID")
			if _groups[sid] ~= nil then
	...
	plsr.Callbacks:RegisterServerCallback("Phone:Chatter:CreateGroup", function(source, data, cb)
		local char = plsr.Fetch:CharacterSource(source)
		if char ~= nil then
			local sid = char:GetData("SID")
			local ts = os.time()
	...
	plsr.Callbacks:RegisterServerCallback("Phone:Chatter:LeaveGroup", function(source, data, cb)
		local char = plsr.Fetch:CharacterSource(source)
		if char ~= nil then
			local sid = char:GetData("SID")
	...
	plsr.Callbacks:RegisterServerCallback("Phone:Chatter:DeleteGroup", function(source, data, cb)
		local char = plsr.Fetch:CharacterSource(source)
		if char ~= nil then
			local sid = char:GetData("SID")
	...
	plsr.Callbacks:RegisterServerCallback("Chatter:Invite:Send", function(source, data, cb)
		local char = plsr.Fetch:CharacterSource(source)
		if char ~= nil then
			local sid = char:GetData("SID")
			...
			if tonumber(data.sid) ~= sid then
				if _groups[sid] then
					...
					if inGroup then
						local tChar = plsr.Fetch:SID(tonumber(data.sid))
						if tChar ~= nil then
	...
	plsr.Callbacks:RegisterServerCallback("Chatter:Invite:Accept", function(source, data, cb)
	...
	plsr.Callbacks:RegisterServerCallback("Chatter:Invite:Decline", function(source, data, cb)
		local char = plsr.Fetch:CharacterSource(source)
		if char ~= nil then
			local sid = char:GetData("SID")
			_invites[sid] = _invites[sid] or {}
	...
	plsr.Callbacks:RegisterServerCallback("Chatter:UpdateGroup", function(source, data, cb)
		local char = plsr.Fetch:CharacterSource(source)
		if char ~= nil then
			local sid = char:GetData("SID")
